    ...
    <div>
      <div className="row">
        <div className="col-lg-12">
          <PageHeader>Alpro Critical</PageHeader>
        </div>
        <div>
        <div className="row ng-scope">
        <div className="col-lg-12">
          <Panel header={<span>Test </span>} >
...
displayAlproCritical.contextTypes = { setTitle: PropTypes.func.isRequired };

export default displayAlproCritical;
